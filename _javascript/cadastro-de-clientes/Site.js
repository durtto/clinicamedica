...
function Principal(){
	...
	var inputs = $("form-clientes").getElementsByTagName("input");
	var tipoDeCliente = Array();
	var fisicaRadio, juridicaRadio;
	var cont = 0;
	for(var i = 0; i < inputs.length; i++){
		if(inputs[i].getAttribute("type") == "radio" && inputs[i].getAttribute("name") == "tipoDeCliente"){
	...
	*/
	var tipoDePessoaAtual = document.getElementsByName("tipoDeCliente")[0].checked ? "fisica" : "juridica";
